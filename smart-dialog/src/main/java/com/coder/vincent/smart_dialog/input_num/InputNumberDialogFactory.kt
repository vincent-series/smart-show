...
internal class InputNumberDialogFactory {
    private val definition: InputNumberDialog = InputNumberDialog()

    fun produceDialog(activity: Activity, config: InputNumberDialog.Config): Dialog =
