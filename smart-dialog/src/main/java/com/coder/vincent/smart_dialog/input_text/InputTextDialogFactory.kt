...
internal class InputTextDialogFactory {
    private val definition: InputTextDialog = InputTextDialog()

    fun produceDialog(activity: Activity, config: InputTextDialog.Config): Dialog =
