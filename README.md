# SmartShow
Smart Toast & Snackbar : 简化调用的同时，处理Toast和Snackbar的常见问题，提高性能和用户体验！作者：朱志强<br/>
## 添加依赖
...
3.如果Toast正在显示，再次触发Toast，如果内容或位置发生了变化，会重新弹出，只具有切换效果，但不会新建Toast实例，且上一个Toast会立即消失，不会等到其duration耗尽再弹出另一个<br/>
