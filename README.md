## SmartShow
android studio 升至3.4（gradle5.1.1），编译报错问题，请尽快使用最新版本2.7.7
...
<pre><code>
    ...
    implementation 'com.github.the-pig-of-jungle.smart-show:toast:2.7.7'
</code></pre>
...
<pre><code>
    ...
    implementation 'com.github.the-pig-of-jungle.smart-show:dialog:2.7.7'
</code></pre>
...
<pre><code>
    ...
    implementation('com.github.the-pig-of-jungle.smart-show:topbar:2.7.7') {
...
<pre><code>
    ...
    implementation('com.github.the-pig-of-jungle.smart-show:snackbar:2.7.7') {
